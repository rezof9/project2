...
(function ($) {
  ...
  $(".mode").on("click", function () {
    ...
    if (!bodyModeDark) {
      ...
      localStorage.setItem("mode-Crocs", "dark-only");
      $("body").addClass("dark-only");
      $("body").removeClass("light");
    }
    if (bodyModeDark) {
      $(".mode").removeClass("active");
      localStorage.setItem("mode-Crocs", "light");
      $("body").removeClass("dark-only");
      $("body").addClass("light");
    }
  });
  $("body").addClass(
    localStorage.getItem("mode-Crocs")
      ? localStorage.getItem("mode-Crocs")
      : "light"
  );
  $(".mode").addClass(
    localStorage.getItem("mode-Crocs") === "dark-only" ? "active" : " "
  );
  // sidebar filter
  ...
  var trans = [
    ...
    {
        en: "Gallery,widgets & layout.",
        pt: "PainÃ©is, widgets e layout.",
        es: "Paneloj, fenestraÄµoj kaj aranÄo.",
        fr: "Tableaux de bord, widgets et mise en page.",
        de: "Gallery, widgets en lay-out.",
        cn: "ä»ªè¡¨æ¿ï¼Œå°å·¥å…·å’Œå¸ƒå±€ã€‚",
        ae: "Ù„ÙˆØ­Ø§Øª Ø§Ù„Ù…Ø¹Ù„ÙˆÙ…Ø§Øª ÙˆØ§Ù„Ø£Ø¯ÙˆØ§Øª ÙˆØ§Ù„ØªØ®Ø·ÙŠØ·.",
      },
      {
