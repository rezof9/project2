...
<div class="container-fluid">
    <button id="toggle-view"class="btn btn-dark" style="margin-bottom: 10px;">Tampilkan List</button>
                                ...
                                <div class="draggable-zone dropzoneContainer" id="pending">
                                    ...
                                    <div class="card draggable-handle draggable" data-id="{{ $task->id_task }}" data-status="Pending">
                                        <div class="card-body">
                                            ...
                                            <div class="position-absolute top-0 end-0 p-2">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" style="margin: 0px;">
                                                        <a class="dropdown-item" href="#">Tambah Pegawai</a>
                                                        <a class="dropdown-item" href="#">Tambah File</a>
                                                        <a class="dropdown-item" href="#">Buat Pesan</a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="profile-skills mt-1 mb-1">
                                                <h4 class="text-primary mb-2">Skills</h4>
                                                <a href="javascript:void();;" class="btn btn-primary light btn-xs mb-1">Jumlah Pegawai <b>{{ $task->assignmentTasks_count??"0" }}</b> </a>
                                                <a href="javascript:void();;" class="btn btn-primary light btn-xs mb-1">Jumlah File <b>{{ $task->fileTasks_count ??"0" }}</b> </a>
                                                <a href="javascript:void();;" class="btn btn-primary light btn-xs mb-1"><b>{{ $task->messageTasks_count ??"0" }}</b></a>
                                    
                                            <div class="col-4">
                                                <span class="text-muted fs-14">Assignments: {{ $task->assignmentTasks_count }}</span>
                                            </div>
                                            <div class="col-4">
                                                <span class="text-muted fs-14">Files: {{ $task->fileTasks_count }}</span>
                                            </div>
                                            <div class="col-4">
                                                <span class="text-muted fs-14">Messages: {{ $task->messageTasks_count }}</span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col">
                            <div class="kanbanPreview-bx">
                                <div class="draggable-zone dropzoneContainer" id="revised">
                                    <div class="sub-card align-items-center d-flex justify-content-between mb-4">
                                        <div>
                                            <h4 class="fs-20 mb-0 font-w600">Revisi (<span class="totalCount">{{ $tasks->where('status', 'Revisied')->count() }}</span>)</h4>
                                        </div>
                                        <div class="plus-bx">
                                            <a href="javascript:void(0)"><i class="fas fa-plus"></i></a>
                                        </div>
