                                ...
                                <div class="draggable-zone dropzoneContainer" id="pending">
                                    ...
                                    <div class="card draggable-handle draggable" data-id="{{ $task->id_task }}" data-status="Pending">
                                        <div class="card-body">
                                            ...
                                            <!-- Menampilkan jumlah assignmentTasks, fileTasks, dan messageTasks -->
                                            <div class="row mt-3">
                                                <div class="col-4">
                                                ...
                                                <div class="col-4">
                                                    <a href="javascript:void(0);" class="btn btn-outline-light btn-rounded"><i class="far fa-envelope scale5 me-3 text-primary"></i>{{ $task->messageTasks_count }} Comments</a> <span class="text-muted fs-14"></span>
                                                </div>
                                            </div>
