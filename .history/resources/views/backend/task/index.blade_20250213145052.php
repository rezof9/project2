                        ...
                        <div class="col">
                            <div class="kanbanPreview-bx">
                                <div class="draggable-zone dropzoneContainer" id="pending">
                                    ...
                                    <div class="card draggable-handle draggable" data-id="{{ $task->id }}" data-status="Pending">
                                        <div class="card-body">
                        ...
                        <div class="col">
                            <div class="kanbanPreview-bx">
                                <div class="draggable-zone dropzoneContainer" id="ongoing">
                                    ...
                                    <div class="card draggable-handle draggable" data-id="{{ $task->id }}" data-status="Ongoing">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between mb-2">
                                                <span class="text-success">
                                                    <svg class="me-2" width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="col">
                            <div class="kanbanPreview-bx">
                                <div class="draggable-zone dropzoneContainer" id="completed">
                                    ...
                                    <div class="card draggable-handle draggable" data-id="{{ $task->id }}" data-status="Completed">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between mb-2">
                                                <span class="text-success">
                                                    <svg class="me-2" width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="col">
                            <div class="kanbanPreview-bx">
                                <div class="draggable-zone dropzoneContainer" id="revised">
                                    ...
                                    <div class="card draggable-handle draggable" data-id="{{ $task->id }}" data-status="Revisied">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between mb-2">
                                                <span class="text-success">
                                                    <svg class="me-2" width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
...
document.querySelectorAll('.dropzoneContainer').forEach((zone) => {
    new Sortable(zone, {
        ...
        onEnd: function(evt) {
            ...
            const newStatus = evt.from.id;  // Menentukan status baru berdasarkan kolom tujuan
            
            // Kirim perubahan status ke server menggunakan AJAX
            const taskId = draggedElement.getAttribute('data-id');
            const newStatusElement = draggedElement.getAttribute('data-status');
