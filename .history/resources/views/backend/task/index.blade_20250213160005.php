                                    ...
                                    <div class="card draggable-handle draggable" data-id="{{ $task->id_task }}" data-status="Pending">
                                        <div class="card-body">
                                            ...
                                            <div class="profile-skills mt-1 mb-1">
                                                <h4 class="text-primary mb-2">Attribut</h4>
                                                <a href="javascript:void();;" class="btn btn-primary light btn-xs mb-1"> Pegawai  <b>{{ $task->assignmentTasks_count??"0" }}</b> </a>
                                                <a href="javascript:void();;" class="btn btn-primary light btn-xs mb-1"> File  <b>{{ $task->fileTasks_count ??"0" }}</b> </a>
                                                <a href="javascript:void();;" class="btn btn-primary light btn-xs mb-1"> Pesan  <b>{{ $task->messageTasks_count ??"0" }}</b></a>
