                                ...
                                <div class="draggable-zone dropzoneContainer" id="pending">
                                    ...
                                    <div class="card draggable-handle draggable" data-id="{{ $task->id_task }}" data-status="Pending">
                                        <div class="card-body">
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-4">
                                                    <span class="text-muted fs-11">Assignments: {{ $task->assignmentTasks_count }}</span>
                                                </div>
                                                <div class="col-4">
                                                    <span class="text-muted fs-11">Files: {{ $task->fileTasks_count }}</span>
                                                </div>
                                                <div class="col-4">
                                                    <span class="text-muted fs-11">Pesan: {{ $task->messageTasks_count }}</span>
                                                </div>
                                            </div>
