                                    ...
                                    <div class="card draggable-handle draggable" data-id="{{ $task->id_task }}" data-status="Pending">
                                        <div class="card-body">
                                            ...
                                            <div class="position-absolute top-0 end-0 p-2">
                                                <div class="dropdown">
                                                    <button type="button" class="btn btn-secondary light sharp" data-bs-toggle="dropdown" aria-expanded="false">
                                            ...
                                            <div class="profile-skills mt-1 mb-1">
                                                <a type="button" class="btn btn-info">Add to wishlist <span class="btn-icon-end"><i class="fa fa-heart"></i></span>
                                                </a>
                                                <a href="javascript:void();;" class="badge badge-secondary "> File  <b>{{ $task->fileTasks_count ??"0" }}</b> </a>
                                                <a href="javascript:void();;" class="btn btn-black light btn-xs mb-1"> Pesan  <b>{{ $task->messageTasks_count ??"0" }}</b></a>
