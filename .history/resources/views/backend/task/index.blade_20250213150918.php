                        ...
                        <div class="col">
                            <div class="kanbanPreview-bx">
                                <div class="draggable-zone dropzoneContainer" id="revised">
                                    ...
                                    <div class="card draggable-handle draggable" data-id="{{ $task->id_task }}" data-status="Revisied">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between mb-2">
                                                <span class="text-success">
                                                    <svg class="me-2" width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
...
Sortable.create(document.querySelector('.dropzoneContainer'), {
    group: "kanban",
    onEnd(evt) {
        const taskId = evt.item.getAttribute('data-id'); // Ambil ID task
        const newStatus = evt.from.getAttribute('data-status'); // Ambil status baru berdasarkan kolom
