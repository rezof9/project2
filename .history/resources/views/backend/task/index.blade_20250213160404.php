                                    ...
                                    <div class="card draggable-handle draggable" data-id="{{ $task->id_task }}" data-status="Pending">
                                        <div class="card-body">
                                            ...
                                            <div class="position-absolute top-0 end-0 p-2">
                                                <div class="dropdown">
                                                    <button type="button" class="btn btn-warning light sharp" data-bs-toggle="dropdown" aria-expanded="false">
                                            ...
                                            <div class="profile-skills mt-1 mb-1">
                                                <a href="javascript:void();;" class="btn btn-warning light btn-xs mb-1"> File  <b>{{ $task->fileTasks_count ??"0" }}</b> </a>
                                                <a href="javascript:void();;" class="btn btn-warning light btn-xs mb-1"> Pesan  <b>{{ $task->messageTasks_count ??"0" }}</b></a>
