...
<main class="flex-grow p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="nice-select selectize" tabindex="0"><span class="current">Orange</span><div class="nice-select-dropdown"><ul class="list"><li data-value="orange" class="option selected null focus">Orange</li><li data-value="White" class="option null">White</li><li data-value="Purple" class="option null">Purple</li></ul></div></div>
        ...
        <div class="col-span-1">
            <div class="card mb-6">
                <div class="px-6 py-5 flex justify-between items-center">
                    <h4 class="header-title">List Perusahaan</h4>
                    <div>
                        <button class="text-gray-600 dark:text-gray-400" data-fc-type="dropdown" data-fc-placement="left-start" type="button">
                            <i class="mgc_more_1_fill text-xl"></i>
                        </button>
                ...
                <div class="px-4 py-2 bg-warning/20 text-warning" role="alert">
                    <i class="mgc_folder_star_line me-1 text-lg align-baseline"></i> <b>38</b> Total Perusahaan & <b>158</b> Client Projects
                </div>
                ...
                <div class="p-6 space-y-3">
                    <div class="flex items-center border border-gray-200 dark:border-gray-700 rounded px-3 py-2">
                        ...
                        <div class="flex-grow">
                            <h5 class="font-semibold mb-1">Mulyagiri</h5>
                    ...
                    <div class="flex items-center border border-gray-200 dark:border-gray-700 rounded px-3 py-2">
                        ...
                        <div class="flex-grow">
                            <h5 class="fw-semibold my-0">Punabri</h5>
                            <p>16 Projects</p>
                        </div>
                        <div>
                            <button class="text-gray-400" data-fc-type="tooltip" data-fc-placement="top">
                    ...
                    <div class="flex items-center border border-gray-200 dark:border-gray-700 rounded px-3 py-2">
                        ...
                        <div class="flex-grow">
                            <h5 class="fw-semibold my-0">Rpa</h5>
                            <p>24</p>
                        </div>
                        <div>
                            <button class="text-gray-400" data-fc-type="tooltip" data-fc-placement="top">
                    ...
                    <div class="flex items-center border border-gray-200 dark:border-gray-700 rounded px-3 py-2">
                        ...
                        <div class="flex-grow">
                            <h5 class="fw-semibold my-0">Rpp</h5>
                            <p>20</p>
                        </div>
                        <div>
                            <button class="text-gray-400" data-fc-type="tooltip" data-fc-placement="top">
