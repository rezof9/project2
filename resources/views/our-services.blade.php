    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="dlabnav">
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a href="{{ route('dashboard') }}" class="has-arrow " href="javascript:void()" aria-expanded="false">
        ...
        <li><a href="{{ route('pegawai.index') }}" class="has-arrow " href="javascript:void()" aria-expanded="false">
        ...
        ***********************************-->
		...
		@yield('section')
        <div class="pp-scrollable text-white section section-3 pp-section pp-easing active"
     style="
       z-index: 6;
       transform: translate3d(0px, 0px, 0px);
       border: 1px solid #fff;
       min-height: 100vh;      /* agar border memanjang minimal 1 layar penuh */
       box-sizing: border-box; /* memastikan border terhitung di dalam total dimensi */
     ">
    ...
    <div class="scrollable-content">
      <div class="vertical-centred">
        <div class="boxed boxed-inner">
          ...
          <div class="boxed" style="position: relative; z-index: 2;">
            <div class="container">
              <div class="intro">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <ul class="service-list">
                      <li><a class="title-uppercase text-white" href="#">01. Construction &amp; Development</a></li>
                      <li><a class="title-uppercase text-white" href="#">02. Trucking Services</a></li>
                      <li><a class="title-uppercase text-white" href="#">03. Ready-Mix Concrete Supply</a></li>
                      <li><a class="title-uppercase text-white" href="#">04. Project Consultation</a></li>
                    </ul>
                    <a href="#" class="h5 link-arrow text-white">
