...
<body>
    ...
    <div class="container d-flex justify-content-center align-items-center" style="min-height: 60vh; padding-top: 10px; padding-bottom: 10px;">
        ...
        <div class="card shadow-lg rounded-4">
            ...
            <div class="card-body">
                <form action="{{ route('register') }}" method="POST" enctype="multipart/form-data" class="form-valide-with-icon needs-validation" novalidate>
                    @csrf
                    <!-- Email -->
                    <div class="mb-3">
...
<div class="mb-3">
    ...
    <div class="input-group">
        ...
        <span class="input-group-text show-pass" id="togglePasswordConfirmation" style="cursor: pointer;">
            <i class="fa fa-eye-slash"></i>
        </span>
        <div class="invalid-feedback">Please confirm your password.</div>
                    ...
                    <div class="form-group mb-0">
                        ...
                        <p class="mt-4 mb-0 text-center">Don't have account?<a class="ms-2" href="{{ route('login') }}">SignIn</a></p>
                    </div>
