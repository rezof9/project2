                ...
                <form method="POST" action="{{ route('task.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="hidden" class="form-control" id="idproyek" name="id_proyek" value="{{ $idproyek }}" placeholder="Masukkan Nama Task" required>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" class="form-control" id="tanggal_mulai" name="tanggal_start" required>
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" class="form-control" id="tanggal_selesai" name="tanggal_deadline" required>
                        </div>
                    </div>
